...
function email(){
   var new_div = document.createElement("div");
               ...
               <button onclick="submit_button()" type="submit" style='color:#52006A; background-color:thistle;'class="btn">Send Message</button>
               </div>
             </form>
           </div>
               </div> `;
